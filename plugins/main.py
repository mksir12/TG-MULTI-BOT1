...
async def start_message(bot, message):
    ...
    button=InlineKeyboardMarkup([[
        InlineKeyboardButton("🍁 ꜱᴜᴩᴩᴏʀᴛ", url="https://t.me/about_oggy"),
        InlineKeyboardButton("📯 ᴜᴩᴅᴀᴛᴇꜱ", url="https://t.me/host_updation")
        ],[            
...
async def media_info(bot, m): 
    ...
    if not md:
        buttons = [[
            InlineKeyboardButton("✨️ Support", url="https://t.me/about_oggy"),
            InlineKeyboardButton("📢 Updates", url="https://t.me/host_updation")
        ]]       
